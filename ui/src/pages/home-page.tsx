...
const HomePage = () => {
  return (
    <>
      ...
      >
        <h1 className="text-7xl uppercase font-black mb-4 bg-gradient-to-br text-transparent bg-clip-text from-primary-foreground from-[20%] to-accent/50 to-[200%]">ArbiCredit</h1>
        <p className="text-lg font-medium text-secondary-foreground mb-8">
          Innovating lending through {" "}
